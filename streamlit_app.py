...
# --- Firestore init from JSON secret ---
if "db" not in st.session_state:
    # FIREBASE_KEY must be the full JSON string of your serviceAccount.json
